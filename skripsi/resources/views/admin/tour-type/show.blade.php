        ...
        <div class="col-12">
            ...
            <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="exampleFormControlInput3" value="{{ $data->type }}" disabled>
              </div>

              <div class="d-flex justify-content-end">
                <a class="btn btn-secondary mb-2" href="{{route('admin_tour_types.index')}}">Back</a>
            </div>
        </div>
    </div>
    </div>
